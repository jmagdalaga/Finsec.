...
public class ExpensePageDark extends AppCompatActivity implements View.OnClickListener {
    TextView txtGoal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.expense_page_dark);
    ...
    private void buildAddSavingsDialog() {
        ...
        View view = getLayoutInflater().inflate(R.layout.expense_customdialog_dark, null);
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        try {
                            ...
                            Toast.makeText(ExpensePageDark.this, il.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                })
    ...
    public void addView(String goalname, double expense, int percent) {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ExpensePageDark.ExpenseData expenseData = new ExpensePageDark.ExpenseData(expense, percent);
    ...
    public void updateView(String goalname, double expense, int percent) {
        View view = getLayoutInflater().inflate(R.layout.add_expense_dark, null);
    ...
    public void loadData() {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Map<String, ExpensePageDark.ExpenseData> consolidatedData = new HashMap<>();
                        ...
                        for (DataSnapshot goalSnapshot : dateSnapshot.child("Expenses").getChildren()) {
                            ...
                            if (goalSnapshot.child("expense").getValue() != null && goalSnapshot.child("percent").getValue() != null) {
                                ...
                                if (consolidatedData.containsKey(goalName)) {
                                    ExpensePageDark.ExpenseData existingExpenseData = consolidatedData.get(goalName);
                                    existingExpenseData.expense += expense;
                                    existingExpenseData.percent += percent;
                                } else {
                                    consolidatedData.put(goalName, new ExpensePageDark.ExpenseData(expense, percent));
                                }
                ...
                for (Map.Entry<String, ExpensePageDark.ExpenseData> entry : consolidatedData.entrySet()) {
