...
public class CustomDialogDark extends AppCompatDialogFragment {
    ...
    public static CustomDialogDark newInstance(String message) {
        CustomDialogDark fragment = new CustomDialogDark();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.custom_dialog_dark, null);
